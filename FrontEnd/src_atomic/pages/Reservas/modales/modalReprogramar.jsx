  ...
  return (
    <ModalOverlay onClick={!loading ? onClose : null}>
      <ModalContent onClick={e => e.stopPropagation()}>
        ...
        <p>Estancia Actual: {new Date(reserva.llegada).toLocaleDateString('es-CO', { year: 'numeric', month: '2-digit', day: '2-digit' })} al {new Date(reserva.salida).toLocaleDateString('es-CO', { year: 'numeric', month: '2-digit', day: '2-digit' })}</p>
